...
class AgencyAPITest(TestCase):
    ...
    def test_GET(self):
        ...
        self.assertEqual(agencies_json,expected_return)
    ...
    def test_GET_Individual(self):
        ...
        self.assertEqual(agency_json, expected_return)
    ...
    def test_POST_Unauthorized(self):
        ...
        self.assertEqual("Authentication credentials were not provided.",json_response['detail'])
